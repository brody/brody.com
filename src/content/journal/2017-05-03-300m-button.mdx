...
import button from '/src/content/journal/_images/300m-button/cover.png'

{/* import LinkCard from '@components/LinkCard.astro' */}

<Image src={button} alt="A bird sitting on a nest of eggs." class="wide" />

{/* type="Source"
url="https://articles.uie.com/three_hund_million_button/"
title="The $300 Million Button"
domain="uie.com"
/> \*/}
