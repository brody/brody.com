...
pubDate: 2019-08-05 00:00:00
draft: false
slug: 77-things
description: A design-forward, aesthetic exploration of some core principles of design.
# featuredImage: /assets/journal/uber-design-77-things/cover.png
...
import uber77things from '/src/content/journal/_images/uber-design-77-things/cover.png'
...
{/* <LinkCard
  type="Source"
  url="https://medium.com/uber-design/77-things-about-uber-design-4621516e495c"
  title="77 Things About Uber Design"
  domain="medium.com"
/> */}
...
Technical and reLinkCard constraints are excellent catalysts for innovation. Know the constraints (your engineering and PM counterparts will be thrilled), and remember that it's impossible to think outside the box if you have no box to begin with.
...
LinkCard: [77 Things About Uber Design](https://medium.com/uber-design/77-things-about-uber-design-4621516e495c)
