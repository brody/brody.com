...
<Image src={saltSwatch} alt='Salt Design System swatch' class='wide' />
...
- People Management: Feedback, development, performance management, mentoring and hiring
...
1. Each development team decided what framework & language to use leading to the inability to reuse and share components across projects.
...
1. The ability to contribute was essential to the success of the system without needing to add more team members to the design system team.

<div class="flex flex-col flex-auto gap-2 mb-8 wide">
