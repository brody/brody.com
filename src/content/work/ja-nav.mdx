...
<div class="px-5 py-4 mb-10 rounded-md bg-subtle not-prose">
  ...
  <span class="block mb-2 leading-normal text-heading ">
...
<blockquote class='twitter-tweet' data-lang='en'>
	<p lang='en' dir='ltr'>
		We&#39;ve moved (to the left) 👈🏼 Say hello to our new side navigation bar! Visit any JobAdder
		page with a single click and leave space for the important stuff with minimised &amp; expandable
		view options.
